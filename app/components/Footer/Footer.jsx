...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1A8D91] z-0 flex w-full flex-col sm:flex-row sm:justify-evenly lg:w-screen lg:-ml-48 xl:w-screen xl:-ml-48 rounded-t-3xl text-center sm:text-left p-4 sm:p-8">
